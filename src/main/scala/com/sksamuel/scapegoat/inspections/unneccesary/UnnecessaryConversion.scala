...
class UnnecessaryConversion extends Inspection(
  text = "Unnecessary conversion",
  defaultLevel = Levels.Warning,
  description = "Checks for unnecessary toInt on instances of Int or toString on Strings, etc.",
  explanation = "Calling e.g. toString on a String or toList on a List is completely unnecessary and it's an equivalent to identity."
) {
