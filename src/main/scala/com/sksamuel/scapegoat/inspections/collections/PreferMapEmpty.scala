...
class PreferMapEmpty extends Inspection(
  text = "Prefer Map.empty",
  defaultLevel = Levels.Info,
  description = "Checks for use of Map().",
  explanation = "Map[K,V]() allocates an intermediate object. Consider Map.empty which returns a singleton instance without creating a new object."
) {
