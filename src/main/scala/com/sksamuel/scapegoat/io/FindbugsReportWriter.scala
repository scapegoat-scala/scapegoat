...
class FindbugsReportWriter {
  ...
  def xml(projectName: String) =
    ...
    <bugcollection analysistimestamp={System.currentTimeMillis.toString}
                   release=" "
                   sequence="0"
      ...
      <buginstance abbrev="CN" category="BAD_PRACTICE"
                   instancehash={UUID.randomUUID.toString}
                   instanceoccurrencemax="0"
                   instanceoccurrencenum="0" priority="2" type="CN_IMPLEMENTS_CLONE_BUT_NOT_CLONEABLE">
      ...
      <findbugssummary alloc_mbytes="0"
                       clock_seconds="0"
                       cpu_seconds="0"
                       gc_seconds="0"
                       num_packages="0"
                       ...
                       timestamp="Fri, 23 Jul 2010 20:35:05 +0200"
                       total_bugs="0"
                       total_classes="0"
                       total_size="0"
                       vm_version="0">
