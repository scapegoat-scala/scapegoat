...
scalaVersion       := "3.9.0"
crossScalaVersions := Seq("2.12.20", "2.12.21", "2.13.17", "2.13.18", "3.9.0")
...
libraryDependencies ++= Seq(
  "org.scala-lang.modules" %% "scala-xml" % "2.5.0" excludeAll ExclusionRule(organization = "org.scala-lang"),
...
libraryDependencies ++= (if (scalaBinaryVersion.value == "3") {
                           ...
                           Seq(
                             ...
                             compilerPlugin(
                               "org.scalameta" % "semanticdb-scalac" % "4.17.4" cross CrossVersion.full
                             )
                           )
                         })
