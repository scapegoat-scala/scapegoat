...
scalaVersion := "2.13.8"
crossScalaVersions := Seq("2.11.12", "2.12.16", "2.12.16", "2.13.7", "2.13.8")
...
libraryDependencies ++= Seq(
  ...
  "org.scala-lang.modules" %% "scala-collection-compat" % "2.8.0" excludeAll ExclusionRule(organization =
    "org.scala-lang"
  ),
